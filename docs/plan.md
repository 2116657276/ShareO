...
> 更新时间: 2026-07-21 | 当前主线: Phase 2 后端闭环 | 状态事实源: [TASK.md](../TASK.md)

## 执行顺序

1. **可信基线与文档收口**：统一状态、分阶段文档、本地混合运行命令和远端证据口径。
...
| Phase 2 语义搜图 | [phase-2-image-search.md](phases/phase-2-image-search.md) | 后端进行中 | 真实闭环、对账、质量/性能评测 |
| Phase 3 RAG | [phase-3-rag.md](phases/phase-3-rag.md) | 未启动 | 引用正确率、降级、成本/质量报告 |
